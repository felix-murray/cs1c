...
//Sorts numbers by odd and even (odd first, then even)
...
int main()
{
    ...
    //WRONG, types don't match // [1.4] assign fcnPtr1 to point to boo
...
// Third, it looks up which version of function1() to call in D2’s virtual table. This has been set to D2::function1(). 
...
// Upcasting removes access to virtual functions and variables because the virtual pointer
// points to the DerivedSlice, but contains no functions or vars that are also in base class.
// It can only call functions and variables defined inside of the scope of DerivedSlice, 
// but not theBase Slice, as it is not virtual and shared among the classes.
// source: https://www.learncpp.com/cpp-tutorial/125-the-virtual-table/
