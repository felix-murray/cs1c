 ...
 *_________________________________________________________________
 * This function compares the phone numbers of an employee and a
 * programmer object and returns a boolean true/false value based
 * on the outcome.
 *_________________________________________________________________
 * PRE-CONDITIONS
 * employee &employeeObj      : employee to be compared
 * programmer &programmerObj  : programmer to be compared
 * POST-CONDITIONS 
 * This function returns eiter true or false depending on the outcome
